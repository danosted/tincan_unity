...
public class VolumetricCloudsURP : ScriptableRendererFeature
{
    ...
    public class VolumetricCloudsPass : ScriptableRenderPass
    {
        ...
        private static readonly int forwardEccentricity = Shader.PropertyToID("_ForwardEccentricity");
        private static readonly int backwardEccentricity = Shader.PropertyToID("_BackwardEccentricity");
        ...
        private void UpdateMaterialProperties(Camera camera)
        {
            ...
            cloudsMaterial.SetFloat(maxStepSize, cloudsVolume.maxStepSize.value);
            ...
            cloudsMaterial.SetFloat(forwardEccentricity, cloudsVolume.forwardEccentricity.value);
            cloudsMaterial.SetFloat(backwardEccentricity, cloudsVolume.backwardEccentricity.value);
