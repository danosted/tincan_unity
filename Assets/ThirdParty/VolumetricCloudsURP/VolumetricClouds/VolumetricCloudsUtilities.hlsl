                ...
                inout VolumetricRayResult volumetricRay)
{
    ...
    half forwardP = HenyeyGreensteinPhaseFunction(_ForwardEccentricity * PositivePow(_MultiScattering, 0), cosAngle);
    half backwardsP = HenyeyGreensteinPhaseFunction(-_BackwardEccentricity * PositivePow(_MultiScattering, 0), cosAngle);
    phaseFunction[0] = forwardP + backwardsP;

#if NUM_MULTI_SCATTERING_OCTAVES >= 2
    forwardP = HenyeyGreensteinPhaseFunction(_ForwardEccentricity * PositivePow(_MultiScattering, 1), cosAngle);
    backwardsP = HenyeyGreensteinPhaseFunction(-_BackwardEccentricity * PositivePow(_MultiScattering, 1), cosAngle);
    phaseFunction[1] = forwardP + backwardsP;
#endif

#if NUM_MULTI_SCATTERING_OCTAVES >= 3
    forwardP = HenyeyGreensteinPhaseFunction(_ForwardEccentricity * PositivePow(_MultiScattering, 2), cosAngle);
    backwardsP = HenyeyGreensteinPhaseFunction(-_BackwardEccentricity * PositivePow(_MultiScattering, 2), cosAngle);
